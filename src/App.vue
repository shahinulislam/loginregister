...
const pageTitle = "Ostad Login Form"
const imageURL = "https://images.unsplash.com/photo-1548092372-0d1bd40894a3"
...
const showLoginForm = computed(() => loginDisplay.value === "show")
const showRegisterForm = computed(() => registerDisplay.value === "show")
